...
import org.nnn4eu.nfische.dynamicproxy.DynamicProxyApplication;
import org.nnn4eu.nfische.dynamicproxy.MyTransactionInvocationHandler;
...
public class ProxyFactory {
    ...
    private MyCustomProxy createProxy(Object bean) {
        ...
        Object proxyObj = Proxy.newProxyInstance(DynamicProxyApplication.class.getClassLoader(), bean.getClass().getInterfaces(), handler);
